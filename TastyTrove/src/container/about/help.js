  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Welcome to the Recipe Recommendation App! If you have any questions or
        need assistance, check out the information below.
      </Text>
      ...
      <Text style={styles.content}>
        ...
        to our support team at support@example.com.
      </Text>
    </View>
  );
}
